    ...
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder->root('uvdesk')
            ->children()
                ...
                ->node('site_path', 'array')
                    ->children()
                        ->node('member_prefix', 'scalar')->defaultValue('member')->end()
                        ->node('knowledgebase_prefix', 'scalar')->end()
                        ->node('knowledgebase_customer_prefix', 'scalar')->defaultValue('customer')->end()
                    ->end()
                ->end()
