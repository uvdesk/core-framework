...
class CoreFrameworkConfiguration extends HelpdeskExtension
{
    ...
    public function loadDashboardItems()
    {
        return [
            ...
            HelpdeskSection::SETTINGS => [
                ...
                [
                    'name' => 'Swift Mailer',
                    'route' => 'helpdesk_member_swiftmailer_settings',
                    'brick_svg' => self::SWIFTMAILER_BRICK_SVG,
                    'permission'=>'ROLE_ADMIN'
                ],
                [
                    'name' => 'Email Settings',
                    'route' => 'helpdesk_member_emails_settings',
