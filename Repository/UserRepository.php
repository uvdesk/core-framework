...
class UserRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function getCustomerTicketCount($customerId) {
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select('COUNT(t.id) as countTicket')->from('CoreFrameworkBundle:Ticket', 't');
    ...
    {
        $queryBuilder = $this->getEntityManager()->createQueryBuilder()
            ->select('supportGroup.id, supportGroup.name')->from('CoreFrameworkBundle:SupportGroup', 'supportGroup')
    ...
    {
        $queryBuilder = $this->getEntityManager()->createQueryBuilder()
            ->select('supportTeam.id, supportTeam.name')->from('CoreFrameworkBundle:SupportTeam', 'supportTeam')
    ...
    public function getUserSupportGroupReferences(User $user)
    {
        $query = $this->getEntityManager()->createQueryBuilder()
            ->select('ug.id')->from('CoreFrameworkBundle:User', 'u') 
            ->leftJoin('u.userInstance','userInstance')
    ...
    {
        $query = $this->getEntityManager()->createQueryBuilder()
            ->select('ut.id')->from('CoreFrameworkBundle:User', 'u')
            ->leftJoin('u.userInstance','userInstance')
